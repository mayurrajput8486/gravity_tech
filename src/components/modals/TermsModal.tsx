    ...
    >
      <div className="space-y-5 text-sm leading-relaxed text-gray-600">
        <p>
          ...
          enquiry or engaging our services, you agree to be bound by these Terms.
        </p>
        ...
        <section>
          ...
          <p>
            Submitting a business enquiry through this website does not constitute
            a binding contract. GravityTech will review submitted information and
            respond with a proposal, which becomes binding only upon mutual written
            agreement (SOW or contract) signed by both parties.
          </p>
        </section>
        ...
        <p className="border-t border-gray-100 pt-4 text-xs text-gray-400">
          By checking &quot;I agree to GravityTech&apos;s Terms & Conditions&quot; on the
          enquiry form, you confirm that you have read, understood, and agree

  ...
  return (
    <div className="space-y-5 text-sm leading-relaxed text-gray-600">
      <p>
        ...
        through our website, enquiry forms, career applications, and during the
        course of any business engagement.
      </p>

      <section>
        <h3 className="mb-2 text-base font-semibold text-gray-900">1. Information We Collect</h3>
        <p>
          When you submit a business enquiry or job application, we may collect:
          your name, email address, phone number, company name, designation, resume,
          portfolio links, and any project or role details you provide. We do not
          require or request sensitive personal information through our forms unless
          legally required for employment.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <li>Evaluate job applications and manage the hiring process</li>
          <li>Schedule discovery calls or meetings related to your request</li>
          <li>Maintain internal records of business and recruitment communications</li>
          <li>Improve our services based on aggregate, anonymized trends</li>
        </ul>
        <p className="mt-2">
          We do not use enquiry or application data for unrelated marketing
      ...
      <section>
        ...
        <p>
          Enquiry and application information is retained for as long as necessary
          to respond to your request and maintain business records, typically up to
          24 months from the date of submission, unless a longer period is required
          by an active engagement, employment relationship, or applicable law.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          in our practices or for legal compliance. The &quot;Last updated&quot; date on
      ...
      {showAcknowledgment && (
        <p className="border-t border-gray-100 pt-4 text-xs text-gray-400">
          By checking &quot;I agree to GravityTech&apos;s Privacy Policy&quot; on a form, you
          acknowledge that you have read and understood how your information will

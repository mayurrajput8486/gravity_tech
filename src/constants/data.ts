...
export const CLIENTS = [
  {
    name: "IntactBox Systems",
    category: "Enterprise Systems",
    color: "#8b5cf6",
    initials: "IB",
  },
  {
    name: "Appligo Technosoft",
    category: "Technology Services",
    color: "#3b82f6",
    initials: "AT",
  },
  {
    name: "Inbatoz Consultancy",
    category: "Business Consultancy",
    color: "#3b82f6",
    initials: "IC",
  },
  {
    name: "Incub8 Engineering",
    category: "Engineering",
    color: "#3b82f6",
    initials: "I8",
  },
  {
    name: "Webforge Technology",
    category: "Web Technology",
    color: "#10b981",
    initials: "WF",
  },
  {
    name: "Zentonia Technologies",
    category: "Technology Products",
    color: "#3b82f6",
    initials: "ZT",
  },
  {
    name: "LAPD IT Services",
    category: "IT Services",
    color: "#3b82f6",
    initials: "LI",
  },
  {
    name: "Eklakshya Abhyasika",
    category: "Education",
    color: "#3b82f6",
    initials: "EA",
  },
  {
    name: "Agastya Abhyasika",
    category: "Education",
    color: "#ef4444",
    initials: "AA",
  },
  {
    name: "Sarathi Study Center",
    category: "Education",
    color: "#3b82f6",
    initials: "SS",
  },
  {
    name: "Terra Forge Infra",
    category: "Infrastructure",
    color: "#6b7280",
    initials: "TF",
  },
  {
    name: "Hotel Chote Sawkar",
    category: "Restaurant",
    color: "#0ea5e9",
    initials: "CS",
  },
  ...
  {
    name: "Tanushri Suryashakti Enterprises",
    category: "Engineering",
    color: "#0ea5e9",
    initials: "TS",
  },
  {
    name: "Vaishnavi Transport",
    category: "Traveling",
    color: "#0ea5e9",
    initials: "VT",
  },
...
export const HOME_SERVICES = [
  {
    id: "crm",
    title: "CRM Solutions",
    description: "Custom CRM platforms for sales pipelines, AI-assisted lead scoring, and real-time analytics dashboards.",
    icon: Users2,
    accent: "#1fb6e8",
    iconBg: "rgba(31,182,232,0.12)",
    detailRoute: "/services/crm",
    aspectClass: "aspect-[329/246]",
    buttonVariant: "light" as const,
    buttonLabel: "More Details",
    buttonWidth: "group-hover:w-[168px]",
    imageUrl:
      "https://img.magnific.com/free-vector/crm-isometric-flowchart-with-customer-management-user-loyalty-funnel-symbols-vector-illustration_1284-82330.jpg?semt=ais_hybrid&w=740&q=80",
  },
  {
    id: "talent",
    ...
    detailRoute: "/services/talent-acquisition",
    aspectClass: "aspect-square",
    buttonVariant: "dark" as const,
    buttonLabel: "More Details",
    buttonWidth: "group-hover:w-[168px]",
    imageUrl:
      "https://enhancebusinesssolutions.com/wp-content/uploads/2019/05/Talent-Acquisition-1.png",
  },
  {
    id: "enterprise",
    ...
    detailRoute: "/services/enterprise-solutions",
    aspectClass: "aspect-[329/246]",
    buttonVariant: "light" as const,
    buttonLabel: "More Details",
    buttonWidth: "group-hover:w-[168px]",
    imageUrl:
      "https://binaryfolks.com/wp-content/uploads/2025/08/23rd-dec-header.png",
  },
  {
    id: "payroll",
    ...
    detailRoute: "/services/third-party-payroll",
    aspectClass: "aspect-square",
    buttonVariant: "dark" as const,
    buttonLabel: "More Details",
    buttonWidth: "group-hover:w-[168px]",
...
export const WHY_GRAVITYTECH = [
  {
    ...
    description:
      "From MVP to enterprise platforms, we've delivered across industries.",
  },
  {
    icon: Cpu,
  ...
  },
  {
    ...
    description:
      "Our SCIP program deploys trainees on real client work from week 3.",
  },
  {
    icon: Layers,
  ...
  },
  {
    ...
    description:
      "Engineering in Pune. Operations in Dubai. Entity in Delaware.",
  },
  {
    icon: Shield,
...
export const PERKS = [
  {
    ...
    description:
      "Guidance, healthy work habits, and support systems that keep you learning without burnout.",
  },
  {
    icon: Clock,
    title: "Flexible Work Culture",
    description:
      "Balance project work and learning with hybrid, remote-friendly, and adaptive flexibility.",
  },
  {
    icon: TrendingUp,
    title: "Transparent Career Growth",
    description:
      "Clear tracks, fair evaluations, real opportunities, and mentor feedback after every sprint.",
  },
  {
    icon: BookOpen,
    title: "Dedicated Learning Budget",
    description:
      "Access resources, tools, AI workflows, and guided practice for modern software skills.",
  },
  {
    icon: Layers,
    title: "Real Project Ownership",
    description:
      "Own modules, decisions, demos, and improvements instead of only watching others build.",
  },
  {
    icon: Users,
    title: "Community Exposure",
    description:
      "Collaborate with developers, analysts, testers, clients, mentors, and project contributors.",
  },
  {
    icon: Rocket,
    title: "Career Development",
    description:
      "Upskill with workshops, mentorship, code reviews, documentation practice, and mock demos.",
  },
  {
    icon: Monitor,
    title: "High-end Project Tools",
    description:
      "Use modern editors, AI tools, Git workflows, deployment utilities, and collaboration systems.",
  },
  {
    icon: Star,
    title: "Bonus & Referrals",
    description:
      "Extra rewards and recognition for strong delivery, referrals, and consistent improvement.",
  },
  {
    icon: Shield,
    title: "Equal Opportunities",
    description:
      "Freshers, students, switchers, and early-career talent grow through practical work.",
  },
  {
    icon: Presentation,
    title: "Client Demo Exposure",
    description:
      "Present your modules, dashboards, and delivery stories during showcase-style walkthroughs.",
  },
  {
    icon: FileText,
    title: "Portfolio Support",
    description:
      "Get help shaping project explanations, resume bullets, and confidence for technical conversations.",
  },
] as const;
...
export const SCIP_STEPS: { icon: LucideIcon; title: string; desc: string }[] = [
  {
    ...
    desc: "One hiring interview. If selected, you receive a SCIP offer to join GravityTech.",
  },
  {
    icon: BookOpen,
    title: "2–3 Month Training",
    desc: "Hands-on training on your track — development, QA, or Data Analytics — with daily mentor support.",
  },
  {
    icon: Rocket,
    title: "Live Client Projects",
    desc: "After training, you work on real-time GravityTech client deliverables. Real responsibility.",
  },
];

export const SCIP_BENEFITS = [
  "Hired directly by GravityTech",
  "Structured 2–3 month training",
  "Data Analytics track for fresh graduates",
  "Real-time client project exposure",
  "Mentorship from senior engineers",
  "Long-term career path at GravityTech",
] as const;
...
export const CAREERS_PERKS: CareersPerk[] = [
  ...
  },
  {
    ...
    tall: true,
    gradient:
      "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(255,255,255,0.7))",
  },
  {
    icon: TrendingUp,
    title: "Transparent Career Growth",
  ...
  },
  {
    ...
    tall: true,
    gradient:
      "linear-gradient(135deg, rgba(31,182,232,0.08), rgba(255,255,255,0.7))",
  },
  {
    icon: Users,
    title: "Community Exposure",
...
export const EXPLORE_PATHS = [
  ...
  },
  {
    ...
    title:
      "Lead practices, mentor engineers, and influence GravityTech's direction.",
    quote:
...
export const CAREERS_FAQ = [
  ...
  },
  {
    ...
    a: "SCIP (Specialized Corporate Incubation Program) is how GravityTech hires fresh graduates. Apply, attend one interview, receive a SCIP offer, complete 2–3 months of training, then work on real-time client projects. Tracks include Data Analytics.",
  },
  {

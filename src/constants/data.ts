...
export const CLIENTS = [
  ...
  { name: 'Eklakshya Abhyasika', category: 'Education', color: '#3b82f6', initials: 'EA' },
  { name: 'Agastya Abhyasika', category: 'Education', color: '#ef4444', initials: 'AA' },
  ...
  { name: 'Vaishnavi Transport', category: 'Traveling', color: '#0ea5e9', initials: 'VT' }
] as const
